...
//    if ([readString_new isEqualToString:@" , "]) {
//        readString_new = kAppName;
//    }
//    if (readString_new.length == 0) {
//        readString_new = kSg31_com_logo;
//    }
...
//    if ([bottomString isEqualToString:@" , "]) {
//        bottomString = kAppName;
//    }
//    if (bottomString.length == 0) {
//        bottomString = @"sg31.com";
//    }
